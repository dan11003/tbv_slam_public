...
#3
rosrun place_recognition_radar eval_sc --dataset mulran --sequence KAIST02 --experiment_name kaist_sc_test --height_plot true --height_plot_factor 0.1 --marker_width 2 --distance_thresholds 5 --sc_threshold 0.16
