...
BAG_BASE_PATH="${BAG_LOCATION}/boreas" #Change this to the directory where you have the bag files
EVAL_BASE_DIR="${BAG_LOCATION}/TBV_Eval/boreas/${SEQUENCE}"
...
# TBV PARAMS
export experiment_name="boreas_tbv_model_8"
