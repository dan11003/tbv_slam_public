...
#SEQUENCE="DCC02"
#SEQUENCE="DCC03"
#SEQUENCE="Riverside01"
#SEQUENCE="Riverside02"
#SEQUENCE="Riverside03"
...
EVAL_BASE_DIR="${BAG_LOCATION}/TBV_Eval/Mulran_online_test/${SEQUENCE}"
...
# TBV PARAMS
export experiment_name="mulran_tbv_model_8" #"oxford_tbv_model_8"
